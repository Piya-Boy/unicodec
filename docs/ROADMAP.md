...
- [ ] Go SDK (canonical generator)
- [ ] Test vectors generated by Go: plain, encrypted (fixed nonce), edge cases, negatives
- [ ] Node.js SDK
- [ ] Conformance: both SDKs pass all vectors byte-exact
- [ ] Cross-decode: Go↔Node round-trip
